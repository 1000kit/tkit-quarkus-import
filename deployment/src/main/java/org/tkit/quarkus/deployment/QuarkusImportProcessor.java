package org.tkit.quarkus.deployment;
...
class QuarkusImportProcessor {
    ...
    public List<UnremovableBeanBuildItem> unRemovableBeans() {
        ...
        return Collections.singletonList(new UnremovableBeanBuildItem(new UnremovableBeanBuildItem.BeanClassAnnotationExclusion(IMPORT_DATA_ANNOTATION)));
    }
